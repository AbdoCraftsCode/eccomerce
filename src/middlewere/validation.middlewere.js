...
export const generalfields = {
  oldpassword: Joi.string().pattern(new RegExp("^[a-zA-Z0-9]{8,}$")).messages({
    "string.pattern.base":
      "كلمة المرور القديمة يجب أن تتكون من 8 أحرف أو أرقام على الأقل",
  }),
  ...
  code: Joi.string()
    .length(6)
    .pattern(/^\d{6}$/)
    .message("يجب أن يكون الكود مكونًا من 6 أرقام فقط"),
  ...
  DOB: Joi.date()
    .less("now")
    .message("تاريخ الميلاد يجب أن يكون تاريخًا صحيحًا في الماضي"),
